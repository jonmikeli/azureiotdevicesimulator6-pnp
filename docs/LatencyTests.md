...
You will find the Azure Function project [here](https://github.com/jonmikeli/azureiotdevicesimulator6-pnp/tree/master/sources/IoT.Simulator/IoT.Simulator.AF) with the source code.